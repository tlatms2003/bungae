	...
	<div id="wrapper">
					...
					<div class="container text-center">
						<div id="top_header_menu" class="row justify-content-between">
							<div class="col-4 top_header_icon">
								<a href="/bunjaeMini/productdetail.do"> <img
									src="images/market/download.svg" alt="앱 다운로드"> 앱다운로드
										...
										<div class="dropdown-container">
											<div class="dropdown">
												...
												<div class="dropdown-content">
													...
													<a href="login.jsp" class="drop">계정설정</a> <a href="customer.do" class="drop"
										...
										<div class="dropdown-container">
											<div class="dropdown">
												...
												<div class="dropdown-content">
													...
													<a href="myPage.jsp" class="drop">계정설정</a> <a href="customer.do" class="drop"
														style="margin-bottom: 20px;">고객센터</a>
												</div>
											</div>
										</div>
		...
		<div id="main_content">
			...
			<div id="carouselExampleControls" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="images/market/thunder_main_slider1.jpg"
							class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="images/market/thunder_main_slider2.jpg"
							class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="images/market/thunder_main_slider3.jpg"
							class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="images/market/thunder_main_slider4.jpg"
							class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="images/market/thunder_main_slider5.jpg"
							class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="images/market/thunder_main_slider6.jpg"
							class="d-block w-100" alt="...">
					</div>
				</div>
			...
			<div class="banner_wrap">
				<img src="images/market/thunder_main_banner.png"
					alt="번개장터 앱 qr이 있는 배너" width="100%">
				<div class="qr_wrap">
					<img src="images/market/thunder_main_qr.png"
						alt="번개장터 앱 다운로드 qr 코드" class="image_qr">
				</div>
			</div>
			<!--상품 영역-->
                              ...
                              <div class="goods_info">
                                 ...
                                 <div class="goods_price_date">
                                    <span class="goods_price">${product.price}</span> <span>
                                     <%-- class="goods_date_before" id="daysAgo">${product.register_date}</span> --%>
